                ...
                <td>
                    <table width="80%" align="center">
                        <tr>
                                ...
                                <a href="#">
                                    <table align="center"> 
                                        <tr> 
                                            ...
                                            <td> 
                                                <img src="imagens/felchaprabaixo.jpg" class="imgFlecha">
                                            </td> 
                                        </tr>
                                    </table>
                                </a>
                            ...
                            <td width="11%" class="colunaMenu">
                                <table id="tabelaPesquisar">
                                    <tr> 
                                        <td>
                                            <input type="text" placeholder="Pesquisar no Microsoft.com" id="campoPesquisar">
                                        </td>
                                        <td>
                                            <a href="#">
                                                <img src="imagens/search.png" id="imgSearch">
                                            </a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            <td class="colunaMenu" style="text-align: center;">
                                <a href="#">
                                    <table align="center"> 
                                        <tr> 
                                            <td>
                                                <img src="imagens/carrinho.png" id="imgCarrinho">
                                            </td>
                                            <td>
                                                0
                                            </td>
                            ...
                            <td>
                                <a href="#" class="colunaMenu">Entrar</a>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr id="imagem">
                <td style="background-image: url('imagens/winApp.jpg'); background-repeat: no-repeat;">
                    <table style="margin-top: 3%; margin-left: 9%;">
                        ...
                        <tr>
                            <td>
                                Encontre aplicativos gratuitos e pagos para você se divertir, trabalhar ou soltar sua criatividade.
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td width="16.66%" style="vertical-align: top;">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#">Catálogo de Endereços</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                            ...
                            <td width="16.66%" style="vertical-align: top;">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="#">Impacto no Brasil</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="#">Privacidade na Microsoft</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr>
                            <td colspan="3">
                                <table>
                                    <tr>
                                        <td>
                                            <img src="imagens/globe.png" height="24" width="24">
                                        </td>
                                        <td>
                                            Português (Brasil)
                                        </td>
                            ...
                            <td colspan="3">
                                <table align="right">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#">Sobre os nossos anúncios</a>
                                        </td>
                                        <td>
                                            © 2016 Microsoft
                                        </td>
